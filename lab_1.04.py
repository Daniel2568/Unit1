...
# Intro
print("You are cleaning the attic and end up finding a dusty lantern")
print("You think it looks kind of cool so you dust it off")
print("Its starts to glow and something comes out of it")
print("The blue glow becomes a Magic Genie")
print("I am an all powerful Genie, You may ask for three wishes")
